...
def create_rnd_map(imsize=32, p=0.50, train=False):
    ...
    :param imsize: the size of the input image 
    :type imsize: int 
    :param p: threshold value
    :type p: float
    :param train: used for training
    :type train: bool
    :return: the image as a PIL image
    :rtype: PIL.Image
    :return: if in train model, the image as a tensor
    :rtype: torch.Tensor
    """
...
def msg_to_map(message, imsize=32, train_mode=False):
    ...
    :param message: The message that you want to embed in a map
    :type message: list || np.ndarray || torch.tensor
    :param imsize: size of the image
    :type imsize: int 
    :param train_mode: used for training 
    :type train_mode: bool
    :return: tensor of combined results
    :rtype: torch.Tensor
    :return: the image as a PIL image
    :rtype: PIL.Image
    :return: if in train model, the image as a tensor
...
def map_to_msg(im, train_mode=False):
    ...
    :param im: the image
    :type im: torch.tensor of a map of a message (black and white)
    :param train_mode: used for training
    :type train_mode: bool
    :return: a plaintxt message
    :rtype: string
    """
...
def encode_msg_bit(cover, msg, bits=4, train_mode=False):
    ...
    :param cover: open image (image opened with PIL)
    :type cover: Image
    :param msg: message to be embedded in img
    :type msg: str
...
def encode_msg(cover, msg, train_mode=False):
    ...
    :param cover: open image (image opened with PIL)
    :type cover: Image
    :param msg: message to be embedded in image 
    :type msg: str
    :param train_mode: used for training 
    :type train_mode: bool
    :return: tensor of image
...
def hide_secret_msgs(covers, msgs):
    ...
    to create stego images. Need to have image open prior to
    call.

    :param covers: images from cifar-10 
    :type covers: torch.Tensor
    :param msgs: messages to encode
    :type msgs: list[str]
    :return: stego images in the shape of covers
    :rtype: torch.Tensor
    """
...
def encode_img(cover, secret, train_mode=False):
    ...
    :param train_mode: used for training
    :type train_mode: bool
    :return: path to the saved stego image
    :rtype: str
    :return: path to the saved stego image
    :rtype: str
...
def hide_secret_imgs(covers, secrets):
    ...
    :param covers: images from cifar-10
    :type covers: torch.Tensor
    :param secrets: images from cifar-10
    :type secrets: torch.Tensor
    :return: stego images in the shape of covers
    :rtype: torch.Tensor
    """
    # [bs, 3, 32, 32]
...
def decode_msg(carrier):
    ...
    :param carrier: can be either tensor format or image format
    :type carrier: Image
    :return: the secret message embedded in the image
    :rtype: str
    """
...
def decode_img(carrier, train_mode=False):
    ...
    :param carrier: can be in either tensor format or image format
    :type carrier: Image
    :param train_mode: used for training
    :type train_mode: bool
    :return: the secret image embedded in the carrier
    :rtype: torch.Tensor
    """
    if train_mode:
...
def reveal_secret_imgs(carriers):
    ...
    :param carriers: containers from which to reveal secret images
    :type carriers: torch.Tensor
    :return: stego images in the shape of covers
    :rtype: torch.Tensor
    """
    # [bs, 3, 32, 32]
...
def str_to_bin(msg):
    ...
    :param msg: a message
    :type msg: str
    :return: the string translated to binary
    :rtype: list[bool]
    """
...
def bin_to_str(b):
    ...
    :param b: list of binary values making up the str
    :type b: list[bool]
...
def format_msg(img_data, msg):
    """Helper function. Used to embed message into a flattened image array

    :param img_data: flattened image data
    :type img_data: list 
    :param msg: the message to embed in the cover image
    :type msg: str
    :return: flat array with data embedded
    :rtype: list
    """
...
def save_as_png(img_data, img_path="new_png", save=False):
    ...
    :param img_data: jpeg image data
    :type img_data: Image 
