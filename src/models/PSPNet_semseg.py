"""
PSPNet model implementation for semantic segmentation.
"""
...
class PSPNetSemseg(nn.Module):
    def __init__(self, classes=2, backbone="mobilenet_v2", c_in=3):
        """PSPNet model with a semantic segmentation head.
        ...
        :type c_in: int
        """    
        super(PSPNetSemseg, self).__init__()
        model = smp.PSPNet(
