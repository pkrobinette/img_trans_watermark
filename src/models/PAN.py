"""
PAN model implementation for denoising.
"""
...
class PANModel(nn.Module):
    def __init__(self, backbone="mobilenet_v2", c_in=3):
        ...
        self.output_conv = nn.Sequential(
            ...
            nn.Upsample(scale_factor=4.0, mode='bilinear', align_corners=False)  # align_corners is often set to False for bilinear upsampling
        )
        #
        # Activation function
        #
